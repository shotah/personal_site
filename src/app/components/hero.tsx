  ...
  return (
    ...
    >
      <div className="hero-content">
        ...
        <p className="mt-3">
          <a
            href="mailto:christopherblodgett@gmail.com"
            className={`link-${theme === 'dark' ? 'light' : 'dark'} text-decoration-none`}
          >
            christopherblodgett@gmail.com
          </a>{' '}
          |{' '}
          <a
            ...
            className={`link-${theme === 'dark' ? 'light' : 'dark'} text-decoration-none`}
          >
            linkedin.com/in/christopherblodgett
          </a>
        </p>
